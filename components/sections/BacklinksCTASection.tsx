    ...
    <section className="py-10 px-4">
      <Container size="lg">
        <div className="w-full max-w-[1126px] min-h-[194px] lg:h-[194px] mx-auto bg-gradient-to-br from-[#5048E5] via-purple-600 to-[#8B63E9] rounded-[40px] shadow-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row items-center lg:items-center h-full py-8 lg:py-0 gap-6 lg:gap-0">
            ...
            <div className="flex flex-col gap-4 lg:gap-2.5 flex-1 px-6 lg:py-6 lg:pl-[52px] text-center lg:text-left w-full lg:w-auto">
              <h2 className="font-inter font-semibold text-white flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2 lg:gap-3" style={{ fontSize: 'clamp(20px, 3vw, 24px)', lineHeight: '1.2' }}>
                <span>Need backlinks while waiting?</span>
                <span className="text-2xl" role="img" aria-label="gift">🎁</span>
              </h2>
              
              <p className="font-inter text-sm sm:text-base font-normal text-white/90 max-w-md mx-auto lg:mx-0" style={{ lineHeight: '1.5' }}>
            ...
            <div className="hidden lg:block relative h-full flex-shrink-0 w-[calc(50%-80px)] mr-20">
              <Image
